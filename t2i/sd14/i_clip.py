...
from filters.i_clip_filter import DeepFloydDataFiltering
...
class ModelWorker():
    def __init__(self):
        self.base = None
        self.refiner = None
        self.check = DeepFloydDataFiltering(verbose=False, device=device)
    ...
    def generate_image(self, prompt):
        ...
        _, nsfw = self.check(images_tensor)
...
if __name__ == '__main__':
    ...
    uvicorn.run(app, host="0.0.0.0", port=31003, log_level="info")
